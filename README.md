...
8. 构建完成，开始你的coding之旅
### top-react new
- -c或者--config top-react.config.js
- -d或者--dest 指定模板生成路径
```
top-react new page //新建一个页面
top-react new component //新建一个组件
```
**top-react.config.js配置示例：**
```
...
module.exports={
  bid:{
    ...
    page: {
      output:path.join(__dirname,'src/views'),
      templates:[
        {
          name:'PageSample',
...
top-react new page 和 top-react new component具体在项目中的使用可参考如下这个项目：
